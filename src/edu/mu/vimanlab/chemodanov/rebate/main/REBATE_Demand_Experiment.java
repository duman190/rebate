...
import edu.mu.vimanlab.chemodanov.rebate.util.ImportZooGraph;
import edu.mu.vimanlab.chemodanov.rebate.util.MinMaxUtil;
import edu.mu.vimanlab.chemodanov.rebate.util.Pair;
import edu.mu.vimanlab.chemodanov.rebate.util.Util;
 ...
 */
public class REBATE_Demand_Experiment {
    ...
    public static void main(String[] args) {
        ...
        //store variables
        double[][] Opt_util = new double[pairNum.length][trialNum];

        double[][] GP_HM_util = new double[pairNum.length][trialNum];

        double[][] RG1_050_HM_util = new double[pairNum.length][trialNum];
        double[][] RG1_075_HM_util = new double[pairNum.length][trialNum];
        double[][] RG1_100_HM_util = new double[pairNum.length][trialNum];
        double[][] RG1_125_HM_util = new double[pairNum.length][trialNum];
        double[][] RG1_150_HM_util = new double[pairNum.length][trialNum];
        ...
        double[][] GP_GE_util = new double[pairNum.length][trialNum];

        double[][] RG1_050_GE_util = new double[pairNum.length][trialNum];
        double[][] RG1_075_GE_util = new double[pairNum.length][trialNum];
        double[][] RG1_100_GE_util = new double[pairNum.length][trialNum];
        double[][] RG1_125_GE_util = new double[pairNum.length][trialNum];
        double[][] RG1_150_GE_util = new double[pairNum.length][trialNum];
        ...
        for (int p = 0; p < pairNum.length; p++)
            for (int trial = 0; trial < trialNum; trial++) {
                ...
                new MinMaxUtil().solveMinMaxUtil(srcDstPairs, D, t, true);
                System.out.println("+[Opt_TE] min of the max edge utilization=" + computeMaxUtil(t.getGraph().getEdgesArray()) + " has been achieved. Total throughput=" + sum(D));
                Opt_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/Opt_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                ...
                Util.exportEdgesUtil("results/experiment1/Util/GP_HM_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/GP_HM_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();

                //REBATE Global goes here..
                isFlowIncreasing = true;
                REBATE_DUAL_Global rebateGlobal = new REBATE_DUAL_Global();
                rebateGlobal.setDeg(0.5);
                ...
                System.out.println("+[RG1_050_HM] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_050_HM_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_050_HM_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_050_HM_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();

                isFlowIncreasing = true;
                rebateGlobal = new REBATE_DUAL_Global();
                rebateGlobal.setDeg(0.75);
                currentFlow = new double[D.length];
                while (isFlowIncreasing) {
                    isFlowIncreasing = false;
                    for (int i = 0; i < D.length; i++)
                ...
                System.out.println("+[RG1_075_HM] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_075_HM_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_075_HM_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_075_HM_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
                ...
                System.out.println("+[RG1_100_HM] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_100_HM_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_100_HM_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_100_HM_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
                ...
                Util.exportEdgesUtil("results/experiment1/Util/RG1_125_HM_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_125_HM_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();

                isFlowIncreasing = true;
                rebateGlobal = new REBATE_DUAL_Global();
                rebateGlobal.setDeg(1.5);
                currentFlow = new double[D.length];
                while (isFlowIncreasing) {
                    isFlowIncreasing = false;
                    for (int i = 0; i < D.length; i++)
                ...
                System.out.println("+[RG1_150_HM] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_150_HM_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_150_HM_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_150_HM_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();


                //REBATE Local goes here...
                isFlowIncreasing = true;
                REBATE_DUAL_Local rebateLocal = new REBATE_DUAL_Local(N);
                rebateLocal.setDeg(0.5);
                currentFlow = new double[D.length];
                while (isFlowIncreasing) {
                    isFlowIncreasing = false;
                    for (int i = 0; i < D.length; i++)
                ...
                Util.exportEdgesUtil("results/experiment1/Util/GP_GE_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/GP_GE_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
                ...
                System.out.println("+[RG1_050_GE] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_050_GE_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_050_GE_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_050_GE_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
                ...
                System.out.println("+[RG1_075_GE] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_075_GE_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_075_GE_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_075_GE_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
                ...
                System.out.println("+[RG1_125_GE] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_125_GE_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_125_GE_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_125_GE_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
                ...
                System.out.println("+[RG1_150_GE] min of the max edge utilization of " + computeMaxUtil(t.getGraph().getEdgesArray())
                        + " has been achieved; demands of " + computeNumOfSatisfied(D, currentFlow)
                        + " pairs have been satisfied in total. Num of fully utilized edges=" + numOfSaturatedEdges(t.getGraph().getEdgesArray())
                        + ". Total throughput=" + sum(currentFlow));
                RG1_150_GE_util[p][trial] = computeMaxUtil(t.getGraph().getEdgesArray());
                Util.exportEdgesUtil("results/experiment1/Util/RG1_150_GE_PairNum_" + pairNum[p] + ".txt", t.getGraph());
                Util.exportValue("results/experiment1/Satisfied/RG1_150_GE_PairNum_" + pairNum[p] + ".txt", Double.valueOf(computeNumOfSatisfied(D, currentFlow))/pairNum[p]);
                t.getGraph().releaseAllResources();
        ...
        System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
        System.out.println("Opt = " + Arrays.deepToString(Opt_util) + ";");
        System.out.println();
        System.out.println("GP_HM = " + Arrays.deepToString(GP_HM_util) + ";");
        System.out.println();
        System.out.println("RG1_050_HM = " + Arrays.deepToString(RG1_050_HM_util) + ";");
        System.out.println("RG1_075_HM = " + Arrays.deepToString(RG1_075_HM_util) + ";");
        System.out.println("RG1_100_HM = " + Arrays.deepToString(RG1_100_HM_util) + ";");
        System.out.println("RG1_125_HM = " + Arrays.deepToString(RG1_125_HM_util) + ";");
        System.out.println("RG1_150_HM = " + Arrays.deepToString(RG1_150_HM_util) + ";");
        System.out.println();
        System.out.println("RL1_050_HM = " + Arrays.deepToString(RL1_050_HM_util) + ";");
        System.out.println("RL1_075_HM = " + Arrays.deepToString(RL1_075_HM_util) + ";");
        System.out.println("RL1_100_HM = " + Arrays.deepToString(RL1_100_HM_util) + ";");
        System.out.println("RL1_125_HM = " + Arrays.deepToString(RL1_125_HM_util) + ";");
        System.out.println("RL1_150_HM = " + Arrays.deepToString(RL1_150_HM_util) + ";");
        System.out.println();
        System.out.println("GP_GE = " + Arrays.deepToString(GP_GE_util) + ";");
        System.out.println();
        System.out.println("RG1_050_GE = " + Arrays.deepToString(RG1_050_GE_util) + ";");
        System.out.println("RG1_075_GE = " + Arrays.deepToString(RG1_075_GE_util) + ";");
        System.out.println("RG1_100_GE = " + Arrays.deepToString(RG1_100_GE_util) + ";");
        System.out.println("RG1_125_GE = " + Arrays.deepToString(RG1_125_GE_util) + ";");
        System.out.println("RG1_150_GE = " + Arrays.deepToString(RG1_150_GE_util) + ";");
        System.out.println();
        System.out.println("RL1_050_GE = " + Arrays.deepToString(RL1_050_GE_util) + ";");
        System.out.println("RL1_075_GE = " + Arrays.deepToString(RL1_075_GE_util) + ";");
        System.out.println("RL1_100_GE = " + Arrays.deepToString(RL1_100_GE_util) + ";");
        System.out.println("RL1_125_GE = " + Arrays.deepToString(RL1_125_GE_util) + ";");
        System.out.println("RL1_150_GE = " + Arrays.deepToString(RL1_150_GE_util) + ";");
    }
